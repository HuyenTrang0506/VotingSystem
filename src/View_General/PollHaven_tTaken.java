...
import Models.Poll;
import Models.User;
import View_Admin.ManageUserView;
...
public class PollHaven_tTaken extends JFrame implements ActionListener, MouseListener {

	private JPanel contentPane;
	private JTable table;
	private JTextField textFieldSearch;
	private ArrayList<Poll> listPoll;
	private ArrayList<Poll> listPollHaventTaken;
	...
	public PollHaven_tTaken(String s, User userSession) {
		
		super(s);
		this.userSession=userSession;
		
		listPollHaventTaken= new ArrayList<Poll>();
		...
		for(Poll p:listPoll) {
			if (p.getStartTime().compareTo(now) > 0 ) {
				listPollHaventTaken.add(p);
		...
		for (Poll p : listPollHaventTaken) {
		...
		lblHaventTakenPlace.setForeground(new Color(255, 69, 0));
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (poll.getStartTime().compareTo(now) > 0)  {
					new EditPollView(listPollHaventTaken, model, getRow);
				}else {
		...
		btnNewButton_1.setBounds(260, 547, 384, 44);
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new StaticOverTimeView(listPollHaventTaken);
			}
		});
		btnNewButton_1_1.setForeground(new Color(255, 255, 255));
		btnNewButton_1_1.setFont(new Font("Tahoma", Font.PLAIN, 20));
		btnNewButton_1_1.setBounds(669, 478, 384, 44);
		...
		btnNewButton_1_1_2.setBounds(669, 550, 384, 41);
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new SortPollView(listPollHaventTaken,clone);
			}
		});
		...
		JButton btnNewButton_1_1_1 = new JButton("Create new voting poll");
		btnNewButton_1_1_1.setVisible(isVisible);
		...
		btnNewButton_1_1_1.setBounds(260, 478, 384, 44);
