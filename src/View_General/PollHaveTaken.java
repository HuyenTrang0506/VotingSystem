...
import View_Admin.*;
public class PollHaveTaken extends JFrame implements ActionListener, MouseListener {

	private JPanel contentPane;
	private JTable table;
	private JTextField textFieldSearch;
	private ArrayList<Poll> listPoll;
	private ArrayList<Poll> listPollHaveTaken;
	private DefaultTableModel model;
	private int getRow;
	private JComboBox comboBox;
	private  User userSession;

	public PollHaveTaken(String s, User userSession) {
		
		super(s);
		this.userSession=userSession;
		listPollHaveTaken= new ArrayList<Poll>();
		...
		lblHaveTakenPlace.setForeground(new Color(255, 51, 51));
		...
		lblUsers.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				dispose();
				if(userSession.getDecentralize()==1) {
					new ManageUserView("Administrator", userSession);
				}else {
					new ManageUserView("User", userSession);
				}
			}
		});
		...
		btnNewButton_1_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				new StaticOverTimeView(listPollHaveTaken);
			}
		});
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				new SortPollView(listPollHaveTaken,clone);
			}
		});
		...
		JButton btnNewButton_1_1_1 = new JButton("View Result");
